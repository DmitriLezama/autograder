...
public class ChatBotPlatformGrade extends GradeTemplate {
    ...
    // Constructor - 2 marks
    /*
     * 1 mark for testing that the constructor initializes ChatBotPlatform correctly.
    ...
    /*
     * Tests should be less strict on full string matching and instead test for key parts.
