...
/**
 * A concrete implementation of {@link GradeTemplate} for grading the chatbot.
...
public class ChatBotGrade extends GradeTemplate {
    ...
    /**
     * The total marks available for the chatbot grade, as defined in {@link Constants}.
     */
    private static final int totalMarks = Constants.CHATBOT_GRADE_TOTAL_MARKS;

    /**
     * Constructs a {@link ChatBotGrade} instance using the result of a test.
     * The constructor calls the parent class constructor and initializes the total marks.
     *
     * @param result The result of the test run for the chatbot grade.
     */
    ...
    /**
     * Allocates weightings for each test in the chatbot grade. This method loads the
    ...
    /**
     * Allocates feedback for the chatbot test. This method initializes the feedback map
