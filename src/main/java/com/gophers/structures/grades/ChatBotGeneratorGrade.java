...
/**
 * A concrete implementation of {@link GradeTemplate} for grading the chatbot generator.
 * This class defines how weightings and feedback are allocated for the chatbot generator grade.
 */
public class ChatBotGeneratorGrade extends GradeTemplate {

    /**
     * The total marks available for the chatbot generator grade, as defined in {@link Constants}.
     */
    private static final int totalMarks = Constants.CHATBOT_GENERATOR_GRADE_TOTAL_MARKS;

    /**
     * Constructs a {@link ChatBotGeneratorGrade} instance using the result of a test.
     * The constructor calls the parent class constructor and initializes the total marks.
     *
     * @param result The result of the test run for the chatbot generator.
     */
    ...
    /**
     * Allocates weightings for each test in the chatbot generator grade. This method loads the
     * weightings from the {@link GradeConfigLoader} based on the configuration defined for
     * chatbot generator grading.
     */
    @Override
    ...
    /**
     * Allocates feedback for the chatbot generator test. This method initializes the feedback map
